...
use App\Models\RealStateUnit as ObjModel;
use App\Services\BaseService;
use Yajra\DataTables\DataTables;

class RealStateUnitService extends BaseService
{
    protected string $folder = 'admin/real_state_unit';
    protected string $route = 'real_state_units';
    ...
    {
        if (isset($data['image'])) {
            $data['image'] = $this->handleFile($data['image'], 'RealStateUnit');
        }
