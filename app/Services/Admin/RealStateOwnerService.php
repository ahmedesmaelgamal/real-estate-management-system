...
class RealStateOwnerService extends BaseService
{
    protected string $folder = 'admin/real_state_owner';
    protected string $route = 'real_state_owners';
    ...
    {
        if (isset($data['image'])) {
            $data['image'] = $this->handleFile($data['image'], 'RealStateOwner');
        }
