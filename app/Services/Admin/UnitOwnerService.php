...
use App\Models\UnitOwner as ObjModel;
use App\Services\BaseService;
use Yajra\DataTables\DataTables;

class UnitOwnerService extends BaseService
{
    protected string $folder = 'admin/unit_owner';
    protected string $route = 'unit_owners';
    ...
    {
        if (isset($data['image'])) {
            $data['image'] = $this->handleFile($data['image'], 'UnitOwner');
        }
