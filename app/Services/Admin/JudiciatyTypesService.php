...
class JudiciatyTypesService extends BaseService
{
    protected string $folder = 'admin/Judiciaty_type';
    protected string $route = 'Judiciaty_type';

    public function __construct(protected JudiciatyType $objModel, protected User $users)
    {
