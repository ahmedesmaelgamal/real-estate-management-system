...
class LegalOwnershipService extends BaseService
{
    protected string $folder = 'admin/legal_ownership';
    protected string $route = 'legal_ownerships';
                        ...
                        <ul class="dropdown-menu" style="z-index: 99999; background-color: #EAEAEA;" aria-labelledby="dropdownMenuButton' . $obj->id . '">
                            ...
                            <li>
                                 <button class="dropdown-item text-danger" data-bs-toggle="modal"
                                                    data-bs-target="#delete_modal" data-id="' . $obj->id . '" data-title="' . $obj->title . '">
    ...
    {
        if (isset($data['image'])) {
            $data['image'] = $this->handleFile($data['image'], 'AssociationModel');
        }
