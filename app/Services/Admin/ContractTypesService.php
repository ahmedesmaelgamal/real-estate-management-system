...
use App\Models\ContractType as ObjModel;
use App\Services\BaseService;
use Yajra\DataTables\DataTables;

class ContractTypesService extends BaseService
{
    protected string $folder = 'admin/contract_types';
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($obj)
                ...
                ->addColumn('action', function ($obj) {
                    $canDelete = !$obj->Contracts()->exists() || !$obj->Names()->exists(); 
