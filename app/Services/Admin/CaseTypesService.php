...
class CaseTypesService extends BaseService
{
    protected string $folder = 'admin/case_types';
    protected string $route = 'case_type';

    public function __construct(protected CaseType $objModel, protected User $users)
    {
