...
use App\Models\EmailOtp as ObjModel;
use App\Services\BaseService;
use Yajra\DataTables\DataTables;

class EmailOtpService extends BaseService
{
    protected string $folder = 'admin/email_otp';
    protected string $route = 'email_otps';
    ...
    {
        if (isset($data['image'])) {
            $data['image'] = $this->handleFile($data['image'], 'EmailOtp');
        }
