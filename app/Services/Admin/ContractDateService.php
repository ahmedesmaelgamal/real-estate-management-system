...
use App\Models\ContractDate as ObjModel;
use App\Models\ContractType;
use App\Services\BaseService;
use Yajra\DataTables\DataTables;

class ContractDateService extends BaseService
{
    protected string $folder = 'admin/contract_date';
    protected string $route = 'dates';
