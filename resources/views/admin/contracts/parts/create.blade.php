        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="party_nation_id[first]"
                        id="party_nation_id_first" oninput="this.value = this.value.slice(0, 10)" placeholder="" />
            ...
            <div class="col-4">
                <div class="form-group">
                    ...
                    <input min="10" type="number" class="form-control" name="party_nation_id[second]"
            ...
            <!-- Create Or Edit term -->
            <div class="modal fade" id="termCreateModalCreate" data-backdrop="static" tabindex="-1" role="dialog"
                aria-hidden="true">
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body_termCreateModal" id="modal-body_termCreateModalCreate"></div>
                        <div class="modal-footer_termCreateModal" id="modal-footer_termCreateModalCreate"></div>
...
<script>
    ...
    $(document).on('click', '.createTerm', function(e) {
        ...
        $('#modal-footer_termCreateModalCreate').html(`
    ...
    `);
        ...
        $('#modal-body_termCreateModalCreate').html(loader);

        $('#termCreateModalCreate').find('.modal-title')
            .text("{{ trns('create_term') }}");

        $('#termCreateModalCreate').modal('show');

        setTimeout(function() {
            $('#modal-body_termCreateModalCreate')
                .load('{{ route('terms.create') }}');
        }, 250);
    });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.status == 200) {
                    ...
                    $('#termCreateModalCreate').modal('hide');
