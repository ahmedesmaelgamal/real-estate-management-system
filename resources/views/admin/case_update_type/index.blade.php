...
@section('title')
    {{ config()->get('app.name') }} | {{ trns('case_type_update_settings') }}
@endsection
@section('page_name')
    {{ trns('case_type_update_settings') }}
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card mt-3">
                <div class="card-header">
                    <h3 class="card-title"> {{ trns('case_type_update_settings') }}</h3>
                    <div class="">
                        <button class="btn btn-icon text-white addBtn" style="border: none;">
                            <span>
                                <i class="fe fe-plus"></i>
                            </span> {{ trns('add_new_case_update_type') }}
                        </button>
                    </div>
                </div>
                <div class="card-body">
