    ...
    <div class="row ">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="electric_name" value="{{ $obj->electric_name }}"
                    name="electric_name" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="number" min="1" class="form-control" id="electric_account_number"
                    value="{{ $obj->electric_account_number }}" name="electric_account_number" required>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="number" min="1" class="form-control" id="electric_subscription_number"
                    value="{{ $obj->electric_subscription_number }}" name="electric_subscription_number" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="number" min="1" class="form-control" id="electric_meter_number"
                    value="{{ $obj->electric_meter_number }}" name="electric_meter_number" required>
            </div>
        </div>
