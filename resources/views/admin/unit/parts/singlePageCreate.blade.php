...
@section('title')
    {{ config()->get('app.name') }} | {{ trns('create unit') }}
@endsection
@section('page_name')
...
@section('content')
    ...
    <div>
        ...
        <!-- Create Or Edit Modal -->
        <h2 class="fw-bold" style="color: #00193a;">{{ trns('create_new_unit') }}</h2>
        <form id="addForm" class="addForm" method="POST" enctype="multipart/form-data" action="{{ $storeRoute }}">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <div class="form-group">
                        <label for="association_id" class="form-control-label">{{ trns('association_id') }}
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="real_state_id" id="real_state_id">
                ...
                <input type="hidden" name="submit_type" id="submit_type" value="create_and_redirect">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control percentage-input"
                                           ...
                                           max="100" min="0"
                                           value="${value}" style="border-radius: 5px 0 0 5px;" required>
                                </div>
                            </div>
                        </div>
                    `);
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.length > 0) {
                                let currentLocale =
                                    '{{ app()->getLocale() }}'; // أو أي متغير JS يحمل اللغة الحالية
                                ...
                                response.forEach(realState => {
                                    let name = realState.name[currentLocale] ||
                                        realState.name['en'] || 'N/A';
                                    realStateSelect.append(
