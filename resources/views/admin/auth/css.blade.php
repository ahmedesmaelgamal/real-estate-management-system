...
<link rel="shortcut icon" type="image/x-icon" href="{{isset($setting) ? asset($setting['site_logo']) :  asset('assets/uploads/logo.png')}}">
<style>
   @import url('https://fonts.googleapis.com/css2?family=Fustat:wght@200..800&family=Jost:ital,wght@0,100..900;1,100..900&family=Tajawal:wght@200;300;400;500;700;800;900&display=swap');
    * {
        margin: 0;
        padding: 0;
