...
@section('title')
    {{ config()->get('app.name') }} | {{ trns('contract_location') }}
@endsection
@section('page_name')
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card mt-3">
                <div class="card-header">
                    <h3 class="card-title"> {{ trns('contract_location') }}</h3>
                    <div class="">
                            <button class="btn btn-icon text-white addBtn" style="border: none;">
                                <span>
                                    <i class="fe fe-plus"></i>
                                </span> {{ trns('add_contract_location') }}
                            </button>
                    </div>
                </div>
                <div class="card-body">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-warning mt-3" role="alert">
                            <p id="cantDeleteMessage" class="text-danger fw-bold fs-7">{{trns("sorry_you_cannot_delete_this_trems_it_has_related_contract")}}</p>
                        </div>
                    </div>
                    <div class="modal-footer d-flex flex-nowrap">
        ...
        <div class="modal fade" id="editOrCreate" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="example-Modal3"> {{ trns('contract_location_details') }}</h5>
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
