<div>
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a class="btn btn-icon text-white" href="{{ asset('electric_or_water_example.xlsx') }}">
    ...
    <form id="excel-import-form-electric-or-water" method="POST" enctype="multipart/form-data" action="{{ $storeExcelOfElectricOrWaterRoute }}">
        @csrf
        <div class="row">
            <div class="col-12">
