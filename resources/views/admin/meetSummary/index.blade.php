...
@section('title')
    {{ config()->get('app.name') }} | {{ trns('topics_settings') }}
@endsection
@section('page_name')
    {{ trns('topics_settings') }}
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card mt-3">
                <div class="card-header">
                    <h3 class="card-title"> {{ trns('topics_settings') }}</h3>
                    <div class="">
                            <button class="btn btn-icon text-white addBtn" style="border: none;">
                                <span>
                                    <i class="fe fe-plus"></i>
                                </span> {{ trns('add_new_topic') }}
                            </button>
                    </div>
                </div>
                <div class="card-body">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-warning mt-3" role="alert">
                            <p id="cantDeleteMessage" class="text-danger fw-bold fs-7">{{trns("sorry_you_cannot_delete_this_topic_it_has_related_meetings")}}</p>
                        </div>
                    </div>
                    <div class="modal-footer d-flex flex-nowrap">
